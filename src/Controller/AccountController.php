...
class AccountController extends AbstractController
{
    ...
    public function register(Request $request, ObjectManager $manager, UserPasswordEncoderInterface $encoder) {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash(
                'success',
                "Votre compte à bien été créé ! Vous pouvez maintenant vous conectez !"
            );
    ...
    public function profile(Request $request, ObjectManager $manager) {
        // Permet de récupérer l'utilisateur connecté sur le site !
        $user = $this->getUser();
    ...
    public function updatePassword(Request $request, ObjectManager $manager, UserPasswordEncoderInterface $encoder) {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            // Vérification que le oldPassword du formulaire soit le même que le passowrd de l'user
            if(!password_verify($passwordUpdate->getOldPassword(), $user->getHash())) {
                ...
                $this->addFlash(
                    'success',
                    "Le nouveau mot de passe à bien été enregistré !"
                );
