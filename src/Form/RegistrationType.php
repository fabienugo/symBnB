...
class RegistrationType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('email', EmailType::class, $this->getConfiguration("Email", "Votre addresse mail"))
            ...
            ->add('passwordConfirm', PasswordType::class, $this->getConfiguration("Confirmation du mot de passe", "Entrez votre mot de passe"))
