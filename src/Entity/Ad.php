...
class Ad
{
     ...
     *                 max = 255,
     *                 minMessage = "Le titre doit faire 10 caractères minimum !",
     ...
     *                 minMessage = "L'introduction doit faire 20 caractères minimum !")
     */
     ...
     *                 minMessage = "Le contenu doit faire 100 caractères minimum !")
     */
    private $content;
    ...
    public function getNotAvailableDays() {
        ...
        foreach($this->bookings as $booking) {
            // Obtient toutes les journées entre la date de début et la date de fin en TIMESTAMP
            $resultat = range(
            ...
            // Transforme le timestamp en véritable jour !
